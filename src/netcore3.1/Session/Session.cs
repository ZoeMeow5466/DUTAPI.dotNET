...
namespace ZoeMeow.DUTAPI
{
    public partial class Session : IDisposable
    {
        ...
        /// </summary>
        /// <returns>Trả về trạng thái đăng nhập.</returns>
        public LoginStatus LoggedIn()
        {
            var httpReturn = webClient.Get("http://sv.dut.udn.vn/WebAjax/evLopHP_Load.aspx?E=TTKBLoad&Code=2110");
        ...
        /// <summary>
        /// Đăng nhập sử dụng tài khoản trên trang sv.dut.udn.vn.
        /// </summary>
        /// <param name="username">Tên đăng nhập (Mã sinh viên)</param>
        /// <param name="password">Mật khẩu</param>
        public void Login(string username, string password)
        {
            var values = new Dictionary<string, string>();
            values.Add("__VIEWSTATE", __VIEWSTATE_UTF8);
            values.Add("__VIEWSTATEGENERATOR", "20CC0D2F");
            values.Add("_ctl0:MainContent:DN_txtAcc", username);
            values.Add("_ctl0:MainContent:DN_txtPass", password);
            values.Add("_ctl0:MainContent:QLTH_btnLogin", "Đăng+nhập");
            webClient.Post("http://sv.dut.udn.vn/PageDangNhap.aspx", values);
        }
        ...
        public void Logout()
        {
            webClient.Get("http://sv.dut.udn.vn/PageLogout.aspx");
        }

        #region Const variables
        private static string __VIEWSTATE_UTF8 =
