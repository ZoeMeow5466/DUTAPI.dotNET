...
URL_NEWSGENERAL = 'http://sv.dut.udn.vn/WebAjax/evLopHP_Load.aspx?E=CTRTBSV&PAGETB={page}&COL=TieuDe&NAME=&TAB=0'
URL_NEWSSUBJECTS = 'http://sv.dut.udn.vn/WebAjax/evLopHP_Load.aspx?E=CTRTBGV&PAGETB={page}&COL=TieuDe&NAME=&TAB=0'
URL_ACCOUNTLOGIN = 'http://sv.dut.udn.vn/PageDangNhap.aspx'
URL_ACCOUNTLOGOUT = 'http://sv.dut.udn.vn/PageLogout.aspx'
